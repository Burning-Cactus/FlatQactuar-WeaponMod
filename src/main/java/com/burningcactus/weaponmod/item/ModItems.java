...
import static com.burningcactus.weaponmod.ModItemGroup.WEAPON_GROUP;
...
public class ModItems {
    ...
    public static void registerItems(RegistryEvent.Register<Item> event) {
        event.getRegistry().registerAll(
                ...
                new BattleaxeItem(ItemTier.GOLD, 2, -2.6F, 0.15F, new Item.Properties().group(WEAPON_GROUP)).setRegistryName("golden_battleaxe"),
